                ...
                <Col className="gutter-row" span={7}>
                    ...
                    <div className="news-list">
                        ...
                        >
                            <Menu.Item
                                key="1"
                                style={{ paddingLeft: 0, margin: '20px 0px' }}
                            >
                                <Avatar
                                    src=""
                                    alt="1"
                                ...
                                Jailbreak là gì? Có nên Jailbreak cho iPhone,
                                iPad?
                            </Menu.Item>
                            <Menu.Item
                                key="2"
                            ...
                            >
                                ...
                                Cổng Lightning là gì? Tìm hiểu về cổng kết nối
                                Lightning của Apple
                            </Menu.Item>
                            <Menu.Item
                                key="3"
                            ...
                            >
                                ...
                                Snapchat là gì? Cách tải ứng dụng Snapchat cho
                                điện thoại
                            </Menu.Item>
                            <Menu.Item
                                key="4"
                            ...
                            >
                                ...
                                Kính cường lực Corning Gorilla Glass là gì? Hiệu
                                quả ra sao trên smartphone?
                            </Menu.Item>
                            <Menu.Item
                                key="5"
                                style={{ paddingLeft: 0, margin: '20px 0px' }}
                            >
                                ...
                                Đồng hồ thông minh smartwatch là gì? Có nên mua
                                đồng hồ đeo tay thông minh không?
                            </Menu.Item>
                        </Menu>
                    </div>
                </Col>
                        ...
                        <div className="news-product-promotion">
                            <div className="news-img">
                                ...
                                <div className="news-text">
                                    Cách thức nhận ưu đãi giảm đến 6,4 triệu
                                    đồng khi lên đời Galaxy Z Fold3
                                </div>
                            </div>
                        </div>
                    </div>
